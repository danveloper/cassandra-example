...
public class NewDatapointRepository extends AbstractRepository {
    ...
    public NewDatapointRepository(Cluster cluster, Keyspace keyspace, String tableName, int rollupPeriodMs) {
        ...
        cf.setComparatorTypeAlias("(TimeUUIDType, UTF8Type, UTF8Type, UTF8Type, UTF8Type, LongType)");
    ...
    public void insert(Datapoint datapoint) {
        ...
        columnKey.addComponent(toTimeUUID(timeMs), TimeUUIDSerializer.get());
